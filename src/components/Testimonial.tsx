...
const Testimonial = ({review,reviewr}:ItestimonialProps) => {
  return (
    <div className="bg-background/95  hover:scale-105 transition-all duration-300 ease-in-out my-4 rounded border flex flex-col justify-between cursor-pointer shadow">
